...
created By Hyperion + Hades#2004
...
while True:
    ...
    guild = input(
        f'{Style.BRIGHT}{Fore.MAGENTA}Provide your server ID where you want to clone it ID{Style.RESET_ALL}{Fore.RESET}\n>'
    )
    clearall()
...
async def on_ready():
    try:
        ...
        print(
            f"{Style.BRIGHT}{Fore.BLUE}Visit our Discord server: {Fore.YELLOW}https://dsc.gg/codersplanet{Style.RESET_ALL}"
        )
        print(
